...
test_that("are_identical_trees_posteriors: use from file", {
  ...
  testthat::expect_true(tracerer::is_trees_posterior(posterior_1$trees))
  testthat::expect_true(tracerer::is_trees_posterior(posterior_2$trees))
...
test_that("are_identical_trees_posteriors: use from local simulation", {
  ...
  expect_true(tracerer::is_trees_posterior(posterior_1$trees))
  expect_true(tracerer::is_trees_posterior(posterior_2$trees))
  expect_true(tracerer::is_trees_posterior(posterior_3$trees))
