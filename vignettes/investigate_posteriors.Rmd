...
testit::assert(beastier::is_trees_posterior(posterior_1) == TRUE)
testit::assert(beastier::is_trees_posterior(posterior_2) == TRUE)
testit::assert(beastier::is_trees_posterior(posterior_3) == TRUE)
testit::assert(beastier::is_trees_posterior(posterior_4) == TRUE)
